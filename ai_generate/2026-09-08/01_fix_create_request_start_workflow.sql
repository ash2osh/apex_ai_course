-- =============================================================================
-- Script: 01_fix_create_request_start_workflow.sql
-- Purpose: 1. Add idempotency guard to HR_WORKFLOW_PKG.start_leave_approval
--          2. Add p_workflow_id OUT parameter to HR_LEAVE_PKG.create_request
--             and retain 6-parameter overload for backwards compatibility.
--          3. Automatically initiate the approval workflow from create_request.
--          4. Update HR_AI_PKG.create_leave_request to receive p_workflow_id
--             directly from create_request without redundant workflow calls.
-- Date: 2026-09-08
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- 1. HR_WORKFLOW_PKG BODY (Idempotent workflow initiation)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 2. HR_LEAVE_PKG SPEC (Add 7-parameter overload with p_workflow_id)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. HR_LEAVE_PKG BODY (Implements both create_request procedures)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. HR_AI_PKG BODY (Passes p_workflow_id to create_request)
-- -----------------------------------------------------------------------------
